 ...
 * @author Admin
 */
public class LeTan_ extends javax.swing.JDialog {
private MongoDBConnection database = new MongoDBConnection();
     ...
     */
    public LeTan_(List<Phong> list_Phong,JFrame parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(1500, 470));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LeTan_.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
