...
public class KhuyenMaiDAO {
    ...
    public List<Document> findKhuyenMai(String ngayBatDau,String ngayKetThuc,int tiLeKhuyenMai, String moTa) throws ParseException {
        List<Document> filters = new ArrayList<>();
         SimpleDateFormat dateFormat = new SimpleDateFormat("EEE MMM dd HH:mm:ss z yyyy");
        
        if (ngayBatDau != null && !ngayBatDau.isEmpty()) {
            Date startDate = dateFormat.parse(ngayBatDau);
            filters.add(new Document("ngayBatDau", startDate));
        }
        if (ngayKetThuc != null) {
